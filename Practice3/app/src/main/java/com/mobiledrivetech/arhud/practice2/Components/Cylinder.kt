package com.mobiledrivetech.arhud.practice3.Components
...
import com.mobiledrivetech.arhud.practice3.R
...
class Cylinder private constructor() {
    ...
    fun loadShaderAndProgram(context: Context) {
        ...
        val fragment_shader_source = ReadResouceText.readResoucetText(context, R.raw.ambient_fragment_shader)
        val vertex_shader_source = ReadResouceText.readResoucetText(context, R.raw.ambient_vertex_shader)
