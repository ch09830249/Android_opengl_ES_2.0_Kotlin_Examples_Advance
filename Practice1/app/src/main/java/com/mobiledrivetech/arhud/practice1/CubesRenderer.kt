package com.mobiledrivetech.arhud.practice1
 ...
 */
class CubesRenderer : GLSurfaceView.Renderer {
    /**
    ...
    private var mPointProgramHandle = 0// A constant representing the combined model/view/projection matrix.
    ...
    companion object {
        /** Used for debug logs.  */
        private const val TAG = "CubesRenderer"
    }
