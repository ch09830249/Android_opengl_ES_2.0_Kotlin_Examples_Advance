package com.mobiledrivetech.arhud.practice4.Components
...
import com.mobiledrivetech.arhud.practice4.Helper.MatrixHelper
import com.mobiledrivetech.arhud.practice4.R
import com.mobiledrivetech.arhud.practice4.Util.ReadResouceText
...
//    private var lightColor = 0
    ...
    fun loadShaderAndProgram(context: Context) {
        ...
        val fragment_shader_source = ReadResouceText.readResoucetText(context, R.raw.diffuse_fragment_shader)
        val vertex_shader_source = ReadResouceText.readResoucetText(context, R.raw.diffuse_vertex_shader)
    ...
    fun projectionMatrix(width: Int, height: Int) {
        ...
        // 創建視圖矩陣
        Matrix.setLookAtM(mViewMatrix, 0, 0f, 1f, 2f, 0f, 0f, 0f, 0f, 1f, 0f)
    }
